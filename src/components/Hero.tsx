export default function Hero() {
  return (
    <section className="relative w-full h-screen bg-slate-900 text-white">
      {/* Background Image */}
      <img
      ...
      {/* Content */}
      <div className="relative z-10 h-full flex flex-col justify-center items-start p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl w-full mx-auto">
          <div className="mb-4">
            <span className="inline-block bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs sm:text-sm font-semibold uppercase tracking-widest px-3 py-1.5">
              Labpacs
            </span>
          </div>
          <div className="inline-block bg-black/50 border border-white/20 p-2 sm:p-4 backdrop-blur-sm">
